...
import { ADD_SHOPPING_LIST, DELETE_SHOPPING_LIST, POPULATE_SHOPPING_LISTS, CHANGE_TITLE } from '@/vuex/mutation_types.js'
...
describe('mutations.js', () => {
  ...
  describe('DELETE_SHOPPING_LIST', () => {
    ...
    it('the ID that does not exist in the list will not cause any change', () => {
      state.shoppinglists = [{id: '1'}, {id: '2'}, {id: 3}]
      mutations[DELETE_SHOPPING_LIST](state, '4')
      expect(state.shoppinglists).to.eql([{id: '1'}, {id: '2'}, {id: 3}])
    })
  })
